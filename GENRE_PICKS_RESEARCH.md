...
2. **Smart Candidate Discovery** - Multi-source data aggregation (TMDB, TasteDive, Trakt, Watchmode)
...
const [subgenreSuggestions, setSubgenreSuggestions] = useState<SubgenreSuggestions>({}); // subgenre_key → MovieItem[]
```
