...
const DARKNESS_LEVELS: {
...
}[] = [
  {
    value: "soft",
    label: "Soft",
    description: "Gentle dark mode with lighter grays",
  },
  {
    value: "moderate",
    label: "Moderate",
    description: "Balanced dark mode (default)",
  },
  {
    value: "deep",
    label: "Deep",
    description: "Darker backgrounds for immersion",
  },
  {
    value: "pitch",
    label: "Pitch Black",
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 mb-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
              {mode === "system" &&
                `Using ${effectiveTheme} mode based on your system preference`}
