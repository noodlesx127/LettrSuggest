...
- Netlify hosting
- ECharts for charts
- TMDB + TuiMDB APIs for movie data
...
- Set env vars in Netlify: `NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_ANON_KEY`, `TMDB_API_KEY`, `TUIMDB_API_KEY`
...
- `.gitleaks.toml` allows NEXT*PUBLIC*\* while flagging other keys.
